    ...
    <div class="row">
        <div class="col-4 text-center">
            <div class="rg_box">
                ...
                <h5>Restaurant Login With Deal City</h5>
                <form id="rest_login_form" action="/<?php echo home; ?>/restaurant-login-ajax" method="POST">
                <div class="row mt-4">
        ...
        <?php pkAjax_form("#mylogin_btn","#rest_login_form","#result"); ?>
