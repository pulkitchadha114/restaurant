          ...
          <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
              <div class="card card-plain">
                ...
                <div class="card-body">
                <form id="admin_login_form" action="/<?php echo home; ?>/admin-login-ajax" method="POST">
                    <div class="mb-3">
                    ...
                    <div class="text-center">
                        <div id="adresult"></div>
                      <button type="button" id="adlogin_btn" class="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0">Sign in</button>
                    </div>
                  </form>
                </div>
                <?php pkAjax_form("#adlogin_btn","#admin_login_form","#adresult"); ?>
